...
%
Robert Tubb \cite{TubbThesis} presents  a number of guidelines for creative musical interfaces:
\begin{enumerate}
	\vspace{-10pt}
\setlength\itemsep{-1.2em}
...
\begin{figure}[h]
	\hspace{-30pt}
	\includegraphics[trim = {2cm, 0cm, 2cm, 0cm}, clip, width = 7in]{ImageTestGraph.png}
	\caption{A Perfect User Test using the Blending Interface to control the Image Filtering Algorithm.}
...
\begin{figure}[h]
%	\hspace{-30pt}
	\includegraphics[trim = {0.5cm, 12.5cm, 2cm, 1cm}, clip, width = 6in]{ImageEditing.png}
