...
Some soft-synths have modular designs, such as \emph{Modular} by SoftTube \cite{SoftTube}, and some even allow users to design synthesis modules from scratch, such as \emph{Max/MSP} and \emph{Supercollider}.
