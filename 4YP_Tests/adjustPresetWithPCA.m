function [adjustedPreset] = adjustPresetWithPCA(preset, coeffCell, pcaWeights)
    ...
    adjustedPreset{8}(1:2) = bound(adjustedPreset{8}(1:2), 0, 40);
    adjustedPreset{8}(3) = bound(adjustedPreset{8}(3), 0, 1);
    adjustedPreset{9}(1:2) = bound(adjustedPreset{9}(1:2), 0, 40);
    ...
    adjustedPreset{12} = bound(adjustedPreset{12}, 0, 40);
end