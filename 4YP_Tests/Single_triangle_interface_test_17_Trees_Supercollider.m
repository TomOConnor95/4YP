...
while(isSearching)
    ...
    if isMarkerClicked == true
        ...
        P1HistoryPlot = resetColourOfOldMarker(P1HistoryPlot);
        
        P.currentTreeIndex = markerIndex;
        P1HistoryPlot.index = markerIndex;
        
        P.presetA = P.presetAHistory.get(markerIndex);
        P.presetB = P.presetBHistory.get(markerIndex);
        P.presetC = P.presetCHistory.get(markerIndex);
